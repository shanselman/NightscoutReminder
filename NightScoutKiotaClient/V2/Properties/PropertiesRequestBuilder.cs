...
using NightScoutV3.V2.Properties.Item;
using System;
...
namespace NightScoutV3.V2.Properties {
    /// <summary>
    /// Builds and executes requests for operations under \v2\properties
    /// </summary>
    public class PropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the NightScoutV3.v2.properties.item collection</summary>
        ...
        public PropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/v2/properties";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
...
#nullable enable
        public async Task<NightScoutV3.Models.Properties?> GetAsync(Action<PropertiesRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<NightScoutV3.Models.Properties> GetAsync(Action<PropertiesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
