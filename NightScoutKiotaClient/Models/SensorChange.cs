...
namespace NightScoutV3.Models {
    public class SensorChange : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        public string Display { get; set; }
#endif
        /// <summary>The displayLong property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new SensorChange and sets the default values.
        /// </summary>
        public SensorChange() {
        ...
        public static SensorChange CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SensorChange();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"displayLong", n => { DisplayLong = n.GetStringValue(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteStringValue("displayLong", DisplayLong);
