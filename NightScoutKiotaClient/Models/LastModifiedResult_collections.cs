...
namespace NightScoutV3.Models {
    public class LastModifiedResult_collections : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>
        /// Instantiates a new LastModifiedResult_collections and sets the default values.
        /// </summary>
        public LastModifiedResult_collections() {
        ...
        public static LastModifiedResult_collections CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new LastModifiedResult_collections();
        }
        /// <summary>
