...
using NightScoutV3.V3.Food.History;
using NightScoutV3.V3.Food.Item;
using System;
...
namespace NightScoutV3.V3.Food {
    /// <summary>
    /// Builds and executes requests for operations under \v3\food
    /// </summary>
    public class FoodRequestBuilder {
        ...
        /// <summary>Gets an item from the NightScoutV3.v3.food.item collection</summary>
        ...
        /// <summary>
        /// Instantiates a new FoodRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FoodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/v3/food{?filter_parameters*,sort*,sort%24desc*,limit*,skip*,fields*}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FoodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task<FoodResponse?> GetAsync(Action<FoodRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<FoodResponse> GetAsync(Action<FoodRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<FoodResponse>(requestInfo, FoodResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
        ...
        /// </summary>
        /// <param name="body">Nutritional values of food</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UpdatedDocument?> PostAsync(NightScoutV3.Models.Food body, Action<FoodRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<UpdatedDocument> PostAsync(NightScoutV3.Models.Food body, Action<FoodRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<FoodRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<FoodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new FoodRequestBuilderGetRequestConfiguration();
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(NightScoutV3.Models.Food body, Action<FoodRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(NightScoutV3.Models.Food body, Action<FoodRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new FoodRequestBuilderPostRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
        ...
        /// General search operation through documents of one collection, matching the specified filtering criteria. You can apply&amp;#58;        1) filtering - combining any number of filtering parameters        2) ordering - using `sort` or `sort$desc` parameter        3) paging - using `limit` and `skip` parameters        If successful, HTTP 200 code is returned with JSON array of matching documents as a response content (it may be empty).        This operation requires `read` permission for the API and the collection (e.g. `*:*:read`, `api:*:read`, `*:treatments:read`, `api:treatments:read`).        The only exception is the `settings` collection which requires `admin` permission (`api:settings:admin`), because the settings of each application should be isolated and kept secret. You need to know the concrete identifier to access the app&apos;s settings.
        /// </summary>
        public class FoodRequestBuilderGetQueryParameters {
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// </summary>
        public class FoodRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public FoodRequestBuilderGetQueryParameters QueryParameters { get; set; } = new FoodRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new foodRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public FoodRequestBuilderGetRequestConfiguration() {
        ...
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        public class FoodRequestBuilderPostRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new foodRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
            public FoodRequestBuilderPostRequestConfiguration() {
                Options = new List<IRequestOption>();
                Headers = new RequestHeaders();
            }
        }
