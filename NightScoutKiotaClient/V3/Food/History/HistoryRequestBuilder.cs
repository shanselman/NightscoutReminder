...
using NightScoutV3.V3.Food.History.Item;
using System;
...
namespace NightScoutV3.V3.Food.History {
    /// <summary>
    /// Builds and executes requests for operations under \v3\food\history
    /// </summary>
    public class HistoryRequestBuilder {
        ...
        /// <summary>Gets an item from the NightScoutV3.v3.food.history.item collection</summary>
        ...
        public HistoryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/v3/food/history{?limit*,fields*}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
