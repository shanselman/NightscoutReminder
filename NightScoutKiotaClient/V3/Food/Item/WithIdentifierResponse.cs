...
namespace NightScoutV3.V3.Food.Item {
    public class WithIdentifierResponse : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>Nutritional values of food</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public NightScoutV3.Models.Food? Result { get; set; }
#nullable restore
#else
        public NightScoutV3.Models.Food Result { get; set; }
#endif
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"result", n => { Result = n.GetObjectValue<NightScoutV3.Models.Food>(NightScoutV3.Models.Food.CreateFromDiscriminatorValue); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<NightScoutV3.Models.Food>("result", Result);
