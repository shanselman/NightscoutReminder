...
using NightScoutV3.V3.Entries.History.Item;
using System;
...
namespace NightScoutV3.V3.Entries.History {
    /// <summary>
    /// Builds and executes requests for operations under \v3\entries\history
    /// </summary>
    public class HistoryRequestBuilder {
        ...
        /// <summary>Gets an item from the NightScoutV3.v3.entries.history.item collection</summary>
        ...
        public HistoryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/v3/entries/history{?limit*,fields*}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
