...
namespace NightScoutV3.V3.Entries {
    public class EntriesResponse : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"result", n => { Result = n.GetCollectionOfObjectValues<Entry>(Entry.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<Entry>("result", Result);
