...
using NightScoutV3.V3.Entries.History;
using NightScoutV3.V3.Entries.Item;
using System;
...
namespace NightScoutV3.V3.Entries {
    /// <summary>
    /// Builds and executes requests for operations under \v3\entries
    /// </summary>
    public class EntriesRequestBuilder {
        ...
        /// <summary>Gets an item from the NightScoutV3.v3.entries.item collection</summary>
        ...
        public EntriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/v3/entries{?filter_parameters*,sort*,sort%24desc*,limit*,skip*,fields*}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
...
#nullable enable
        public async Task<EntriesResponse?> GetAsync(Action<EntriesRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<EntriesResponse> GetAsync(Action<EntriesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<EntriesResponse>(requestInfo, EntriesResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
        ...
        /// </summary>
        /// <param name="body">Blood glucose measurements and CGM calibrations</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UpdatedDocument?> PostAsync(Entry body, Action<EntriesRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<UpdatedDocument> PostAsync(Entry body, Action<EntriesRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Entry body, Action<EntriesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Entry body, Action<EntriesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
