...
namespace NightScoutV3.V3.Entries.Item {
    public class WithIdentifierResponse : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>Blood glucose measurements and CGM calibrations</summary>
...
#nullable restore
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"result", n => { Result = n.GetObjectValue<Entry>(Entry.CreateFromDiscriminatorValue); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<Entry>("result", Result);
