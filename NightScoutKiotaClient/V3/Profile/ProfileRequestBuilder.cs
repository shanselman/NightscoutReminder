...
using NightScoutV3.V3.Profile.History;
using NightScoutV3.V3.Profile.Item;
using System;
...
namespace NightScoutV3.V3.Profile {
    /// <summary>
    /// Builds and executes requests for operations under \v3\profile
    /// </summary>
    public class ProfileRequestBuilder {
        ...
        /// <summary>Gets an item from the NightScoutV3.v3.profile.item collection</summary>
        ...
        public ProfileRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/v3/profile{?filter_parameters*,sort*,sort%24desc*,limit*,skip*,fields*}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
...
#nullable enable
        public async Task<ProfileResponse?> GetAsync(Action<ProfileRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ProfileResponse> GetAsync(Action<ProfileRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<ProfileResponse>(requestInfo, ProfileResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
        ...
        /// </summary>
        /// <param name="body">Parameters describing body functioning relative to T1D + compensation parameters</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UpdatedDocument?> PostAsync(NightScoutV3.Models.Profile body, Action<ProfileRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<UpdatedDocument> PostAsync(NightScoutV3.Models.Profile body, Action<ProfileRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(NightScoutV3.Models.Profile body, Action<ProfileRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(NightScoutV3.Models.Profile body, Action<ProfileRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
