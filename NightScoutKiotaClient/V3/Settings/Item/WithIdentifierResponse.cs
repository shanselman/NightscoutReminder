...
#nullable enable
        public NightScoutV3.Models.Settings? Result { get; set; }
#nullable restore
#else
        public NightScoutV3.Models.Settings Result { get; set; }
#endif
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"result", n => { Result = n.GetObjectValue<NightScoutV3.Models.Settings>(NightScoutV3.Models.Settings.CreateFromDiscriminatorValue); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<NightScoutV3.Models.Settings>("result", Result);
