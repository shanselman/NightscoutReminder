...
using NightScoutV3.V3.Treatments.History.Item;
using System;
...
namespace NightScoutV3.V3.Treatments.History {
    /// <summary>
    /// Builds and executes requests for operations under \v3\treatments\history
    /// </summary>
    public class HistoryRequestBuilder {
        ...
        /// <summary>Gets an item from the NightScoutV3.v3.treatments.history.item collection</summary>
        ...
        public HistoryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/v3/treatments/history{?limit*,fields*}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
