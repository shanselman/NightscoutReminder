...
namespace NightScoutV3.V3.Treatments.History.Item {
    /// <summary>
    /// Builds and executes requests for operations under \v3\treatments\history\{lastModified}
    /// </summary>
    public class WithLastModifiedItemRequestBuilder {
        ...
        public WithLastModifiedItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/v3/treatments/history/{lastModified}{?limit*,fields*}";
