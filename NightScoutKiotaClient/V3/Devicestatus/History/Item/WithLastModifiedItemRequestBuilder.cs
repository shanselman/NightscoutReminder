...
namespace NightScoutV3.V3.Devicestatus.History.Item {
    /// <summary>
    /// Builds and executes requests for operations under \v3\devicestatus\history\{lastModified}
    /// </summary>
    public class WithLastModifiedItemRequestBuilder {
        ...
        public WithLastModifiedItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/v3/devicestatus/history/{lastModified}{?limit*,fields*}";
